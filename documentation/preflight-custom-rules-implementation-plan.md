...
## V1 Scope (28 Rules - HTML Parsing Only) ✓ COMPLETE
...
| IMAGE_TITLE_AUTOGENERATED         | Medium   | Image title appears auto-generated from filename or generic placeholder | Yes |
...
export async function runCustomRules(url: string, rulesMap: ReleaseRulesMap): Promise<ResultItemToCreate[]> {
  ...
  // Batch 9: External Link Target rules (optional)
  ...
  // Batch 11: Placeholder Text rules
...
- `checkImageTitleRules($, rulesMap)` - Auto-generated image title detection (optional)
