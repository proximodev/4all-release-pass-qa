...
const releaseRules = [
  ...
  },
  {
    ...
    description: 'Page contains lorem ipsum, TBD, TODO, or other placeholder text that was not replaced with real content. (Check Spelling for specific instances.)',
    severity: 'BLOCKER',
  ...
  },
  {
    ...
    severity: 'MEDIUM',
    impact: 'Meaningless hover tooltips degrade user experience. Often caused by CMS (especially WordPress) auto-populating title from filename.',
